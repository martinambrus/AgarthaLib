...
public class PacketLivingEntity_1_10 extends HandlerPacket implements LivingEntityTools
{
    public PacketLivingEntity_1_10(final AgarthaLib plugin) {
        super(plugin);
    }
    ...
    public boolean isLivingEntity(final EntityType type) {
        ...
        if (
            ...
            simpleTypeClass.equals("TippedArrow") ||
            simpleTypeClass.equals("LingeringPotion")
        ) {
            return false;
        }
