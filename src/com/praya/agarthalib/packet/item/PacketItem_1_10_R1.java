...
public class PacketItem_1_10_R1 extends HandlerPacket implements TagsNBTItem, TagsNBTBooks, TagsNBTCustom
{
    public PacketItem_1_10_R1(final AgarthaLib plugin) {
        super(plugin);
    }
    
    @Override
    public final void setString(final String key, final String parent, final ItemStack item, final String value) {
        final net.minecraft.server.v1_10_R1.ItemStack itemNMS = CraftItemStack.asNMSCopy(item);
    ...
    public final ItemStack createBook(final String name, final int amount, final String title, final String author, final String... pages) {
        ...
        final net.minecraft.server.v1_10_R1.ItemStack cloneBook = CraftItemStack.asNMSCopy(book);
