...
public class PacketItem_1_8_R3 extends HandlerPacket implements TagsNBTItem, TagsNBTBooks, TagsNBTCustom
{
    public PacketItem_1_8_R3(final AgarthaLib plugin) {
        super(plugin);
    }
    ...
    public final ItemStack createBook(final String name, final int amount, final String title, final String author, final String... pages) {
        ...
        final net.minecraft.server.v1_8_R3.ItemStack cloneBook = CraftItemStack.asNMSCopy(book);
