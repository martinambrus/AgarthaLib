...
public class PacketMessage_1_11_R1 extends HandlerPacket implements MessageActionbar, MessageJson, MessageTitle
{
    public PacketMessage_1_11_R1(final AgarthaLib plugin) {
        super(plugin);
    }
    ...
    public String packetGetJsonItem(final ItemStack item) {
        if (item != null) {
            final net.minecraft.server.v1_11_R1.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(item);
