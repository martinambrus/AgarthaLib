...
public class PacketPlayer_1_8_R3 extends HandlerPacket implements PacketPlayerProperties, PacketPlayerVisibility, PacketPlayerCombat, PacketPlayerAbsorption
{
    public PacketPlayer_1_8_R3(final AgarthaLib plugin) {
        super(plugin);
    }
    ...
    public final void playSwingMainHand(final Player player) {
        ...
        if (player != null) {
            ...
            final EntityPlayer entityPlayer = ((CraftPlayer)player).getHandle();
            final PacketPlayOutAnimation packet = new PacketPlayOutAnimation((net.minecraft.server.v1_8_R3.Entity)entityPlayer, 0);
