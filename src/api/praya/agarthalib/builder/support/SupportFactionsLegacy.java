...
public class SupportFactionsLegacy extends Support implements SupportFactions, SupportTerritory
{
    public SupportFactionsLegacy(final AgarthaLib plugin, final Plugin source) {
        super(plugin, source);
    }
    ...
    public final UUID getGroupLeaderByID(final String id) {
        final Faction faction = this.getFactionByID(id);
        if (faction != null) {
            final FPlayer fPlayer = faction.getOwner();
    ...
    public final SupportGroup.SupportGroupRole getPlayerRole(final OfflinePlayer player) {
        if (player != null) {
            final FPlayer fPlayer = FPlayerColl.get((Object)player);
            if (fPlayer != null) {
    ...
    public final Collection<Faction> getAllFactions() {
        ...
        return (Collection<Faction>)factionColl.getAllFactions();
    }
    
    public final Faction getFactionByID(final String id) {
        final FactionColl factionColl = FactionColl.get();
        if (id != null) {
            final Faction faction = factionColl.getFactionById(id);
            if (this.isRealFaction(faction)) {
                return faction;
            }
        }
    ...
    public final Faction getFactionByName(final String name) {
        if (name != null) {
            final Faction faction = FactionColl.get().getByTag(name);
            if (this.isRealFaction(faction)) {
                return faction;
            }
        }
    ...
    private final boolean isRealFaction(final Faction faction) {
        final FactionColl factionColl = FactionColl.get();
        if (faction != null) {
            final Faction wilderness = factionColl.getWilderness();
    ...
    public String getTerritoryOwner(final Location location) {
        if (location != null) {
            final Locality locality = Locality.of(location);
            final Faction faction = locality.getFactionHere();
            if (this.isRealFaction(faction)) {
                final String factionID = faction.getId();
                return factionID;
            }
